...
const SEED_ROWS: SeedRow[] = [
  ...
  { name: 'Vinod', role: 'Quality Assurance', rate: null, isSI: false, isContractor: false, project: 'AboveAll', monthly: mh(41.5, 41, 0, 0, 0, 0) },
  { name: 'MOhan', role: 'Developer', rate: null, isSI: false, isContractor: false, project: 'AboveAll', monthly: mh(80, 120, 0, 0, 0, 0) },
  { name: 'Shikhar Sharma', role: 'Developer', rate: null, isSI: false, isContractor: false, project: 'AboveAll', monthly: mh(0, 3.5, 0, 0, 0, 0) },
  { name: 'Pallavi', role: 'Architect', rate: null, isSI: false, isContractor: false, project: 'AboveAll', monthly: mh(3, 12, 0, 0, 0, 0) },
  ...
  { name: 'Anupama', role: 'Architect', rate: null, isSI: false, isContractor: false, project: 'Copeland', monthly: mh(30, 40, 10, 0, 0, 0) },
  { name: 'Vasanth', role: 'Manager', rate: null, isSI: false, isContractor: false, project: 'Copeland', monthly: mh(3, 0, 0, 0, 0, 0) },
  ...
  { name: 'Syed Mohaseen Elahi Hossain', role: 'Business Analyst', rate: null, isSI: false, isContractor: false, project: 'LLI', monthly: mh(0, 2, 163, 160, 160, 160) },
  ...
  { name: 'Shikhar Sharma', role: 'Developer', rate: null, isSI: false, isContractor: false, project: 'CoolAir', monthly: mh(0, 36, 105, 0, 0, 0) },
  { name: 'Sunil C', role: 'Quality Assurance', rate: null, isSI: false, isContractor: false, project: 'CoolAir', monthly: mh(0, 49.5, 100, 80, 60, 0) },
  { name: 'Vinod', role: 'Quality Assurance', rate: null, isSI: false, isContractor: false, project: 'CoolAir', monthly: mh(0, 2, 50, 40, 30, 0) },
  { name: 'Sandeep', role: 'Developer', rate: null, isSI: false, isContractor: false, project: 'CoolAir', monthly: mh(0, 0, 32, 0, 0, 0) },
  ...
  // Protectolite
  { name: 'Pooja Sharma', role: 'Business Analyst', rate: null, isSI: false, isContractor: false, project: 'Protectolite', monthly: mh(0, 20, 50, 0, 0, 0) },
  ...
  // QUData
  { name: 'Vasanth', role: 'Manager', rate: null, isSI: false, isContractor: false, project: 'QUData', monthly: mh(0, 0, 10, 10, 10, 2.5) },
  { name: 'Anupama', role: 'Architect', rate: null, isSI: false, isContractor: false, project: 'QUData', monthly: mh(0, 0, 40, 40, 40, 10) },
  { name: 'Pooja Sharma', role: 'Business Analyst', rate: null, isSI: false, isContractor: false, project: 'QUData', monthly: mh(0, 0, 60, 80, 80, 50) },
  { name: 'Mohan', role: 'Developer', rate: null, isSI: false, isContractor: false, project: 'QUData', monthly: mh(0, 0, 120, 160, 160, 100) },
  { name: 'Sailendraraj Singh', role: 'Developer', rate: null, isSI: false, isContractor: false, project: 'QUData', monthly: mh(0, 0, 100, 160, 160, 100) },
  { name: 'B Chaithanya Kumar Reddy', role: 'Senior Developer', rate: null, isSI: false, isContractor: false, project: 'QUData', monthly: mh(0, 0, 40, 80, 80, 0) },
  { name: 'Shivam', role: 'Business Analyst', rate: null, isSI: false, isContractor: false, project: 'QUData', monthly: mh(0, 0, 8, 0, 0, 0) },
];
